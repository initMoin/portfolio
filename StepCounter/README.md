...
- **What:** Service that fetches today’s steps via # StepCounter
...
5. Run tests (**⌘U**) to show passing simulated service tests.`HealthKitStore` or returns simulated steps via `SimulatedHealthStore`.
